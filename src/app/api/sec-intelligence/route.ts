...
export async function GET(request: NextRequest) {
  ...
  // When specific tickers are requested, allow any ticker with a CIK mapping
  // (supports Edgar tab calling for stocks outside INTELLIGENCE_TICKERS, e.g. CRCL).
  // When no ticker filter is set, default to the intelligence ticker list.
