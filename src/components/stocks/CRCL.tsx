              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 12 }}>
                  <div style={{ padding: 14, borderRadius: 12, background: 'var(--red-dim)', border: '1px solid var(--red)', textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: 20, fontWeight: 700, fontFamily: 'Space Mono', color: 'var(--red)' }}>${mcSim.p5.toFixed(0)}</div>
                    <div style={{ fontSize: 11, color: 'var(--red)', marginTop: 4, opacity: 0.8 }}>{((mcSim.p5 / MARKET.price - 1) * 100).toFixed(0)}%</div>
                  </div>
                  <div style={{ padding: 14, borderRadius: 12, background: 'var(--surface2)', border: '1px solid var(--border)', textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: 20, fontWeight: 700, fontFamily: 'Space Mono', color: 'var(--text2)' }}>${mcSim.p25.toFixed(0)}</div>
                    <div style={{ fontSize: 11, color: 'var(--text3)', marginTop: 4 }}>{((mcSim.p25 / MARKET.price - 1) * 100).toFixed(0)}%</div>
                  </div>
                  ...
                  <div style={{ padding: 14, borderRadius: 12, background: 'var(--surface2)', border: '1px solid var(--border)', textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: 20, fontWeight: 700, fontFamily: 'Space Mono', color: 'var(--text2)' }}>${mcSim.p75.toFixed(0)}</div>
                    <div style={{ fontSize: 11, color: 'var(--text3)', marginTop: 4 }}>{((mcSim.p75 / MARKET.price - 1) * 100).toFixed(0)}%</div>
                  </div>
                  <div style={{ padding: 14, borderRadius: 12, background: 'var(--mint-dim)', border: '1px solid var(--mint)', textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: 20, fontWeight: 700, fontFamily: 'Space Mono', color: 'var(--mint)' }}>${mcSim.p95.toFixed(0)}</div>
                    <div style={{ fontSize: 11, color: 'var(--mint)', marginTop: 4, opacity: 0.8 }}>{((mcSim.p95 / MARKET.price - 1) * 100).toFixed(0)}%</div>
                  </div>
                </div>
              </div>
