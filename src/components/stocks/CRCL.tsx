...
const MARKET = {
  ...
  // ⚠️ UPDATE REGULARLY - price affects all valuation calculations
...
const MODEL_METADATA = {
  ...
  priceAsOf: 'Dec 31, 2025',  // ⚠️ Update MARKET.price when changing this
};
