      ...
      <div>
        <div className="sm-card sm-mt-8">
          ...
          {[
            ...
            return (
              <div key={i} className="sm-grid-row" data-highlight={row.highlight ? "true" : undefined} style={{ gridTemplateColumns: '1fr 1fr 1fr 1fr', background: row.highlight ? 'var(--accent-dim)' : undefined, cursor: 'default' }}
              >
