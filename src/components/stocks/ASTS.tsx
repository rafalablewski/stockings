...
import { ASTS_COMPETITORS, ASTS_RESEARCH_SOURCES, ASTS_COMPETITOR_LABEL } from '@/data/asts/sources';
...
const ASTSAnalysis = () => {
  ...
  const astsCompetitors = ASTS_COMPETITORS;

  const astsResearchSources = ASTS_RESEARCH_SOURCES;
      ...
      <div className="stock-model-app" data-accent="cyan">
        ...
        <main className="main">
          ...
          {activeTab === 'sources' && <TabPanel id="sources">
            <SharedSourcesTab ticker="ASTS" companyName="AST SpaceMobile" researchSources={astsResearchSources} competitorLabel={ASTS_COMPETITOR_LABEL} competitors={astsCompetitors} />
          </TabPanel>}
