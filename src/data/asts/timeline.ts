...
export const ASTS_TIMELINE_EVENTS = [
    {
      ...
      title: 'TELUS Signs Commercial Agreement with ASTS — Equity Investment and Ground Infrastructure Commitment',
      summary: 'TELUS (TSX:T / NYSE:TU) signs commercial agreement for space-based cellular broadband across Canada; will invest in ground infrastructure and become ASTS equity shareholder',
      details: [
        'Commercial agreement for space-based cellular broadband service across Canada: text, voice, and data',
        'TELUS will invest in ground-based satellite infrastructure — capex commitment for gateways',
        'TELUS to become equity shareholder in AST SpaceMobile — strongest commitment signal from new partner since stc',
        'Planned service availability late 2026 using existing smartphones, no special equipment required',
        'Combines ASTS LEO constellation (largest commercial phased arrays in LEO) with TELUS terrestrial wireless network',
        'Targets Canada\'s vast geography: backcountry, remote job sites, rural areas without traditional cellular infrastructure',
        'Nazim Benhadid (CTO, TELUS Networks): "eliminating connectivity gaps across Canada"',
        'Chris Ivory (ASTS CCO): "redefine what mobile coverage means for Canadians"',
        'Second Canadian MNO partner alongside Bell Canada — near-duopoly wireless coverage in Canada',
        'TELUS: $20B+ annual revenue, 21M+ customer connections, operates in 45+ countries',
        'Forward-looking statements reference 10-K filed March 2, 2026',
      ],
      sources: ['BusinessWire / TELUS / AST SpaceMobile Joint Press Release Mar 3, 2026'],
      prevValue: 'One Canadian MNO partner (Bell Canada, testing phase)',
      newValue: 'Two Canadian MNO partners — TELUS commercial agreement with equity investment + ground infrastructure; Bell Canada in testing',
      impact: 'Positive',
    },
    {
      date: '2026-03-03',
      category: 'Partnership',
      title: 'AXIAN Telecom (Yas) Partners with ASTS for Africa\'s First D2D Space-Based Mobile Broadband',
      summary: 'AXIAN Telecom / Yas partnership for D2D broadband across 11 African markets; 43M+ subscribers; voice, video, data, IoT, maritime, aviation, emergency',
      details: [
        'Partnership to deliver Africa\'s first D2D space-based mobile broadband service',
        'BlueBird LEO satellites integrated with Yas core infrastructure across its markets',
        'Full-service: voice, video, data, internet connectivity in remote, rural, maritime, and aviation zones',
        'Joint commercial offerings for consumers, enterprises, IoT, maritime, aviation, and emergency response',
        'Yas handles local distribution, regulatory coordination, and customer activation via one-click SpaceMobile service',
        'Compatible with evolving 5G and IoT standards; subject to regulatory approvals in each market',
        'Hassan Jaber (CEO, AXIAN Telecom): "technology is genuinely different: works with phones people already own"',
        'Scott Wisniewski (ASTS President): "Africa is a critical part of the global connectivity landscape"',
        'AXIAN/Yas is Africa\'s 6th largest mobile operator: 43M+ customers across 11 markets',
        'Markets: Tanzania, Madagascar, Togo, Senegal, Uganda, Kenya, DRC, Comoros, Malawi, Réunion, Mayotte',
        'Supports Yas Data4All strategy for quality network access across all markets',
      ],
      sources: ['AXIAN Telecom Press Release (~Mar 2026, exact date undisclosed)'],
      prevValue: 'No dedicated Africa-primary MNO partner',
      newValue: 'AXIAN Telecom/Yas partnership — 43M subs, 11 African markets, first Africa-focused D2D broadband agreement',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
    ...
    },
    {
      ...
      details: [
        'Vodafone Romania partnered with Satellite Connect Europe for D2D satellite connectivity trials',
        'Trial of open-access D2D services to begin in Romania summer 2026',
        'Integration of satellite capability into existing 4G/5G networks — smartphones switch automatically between terrestrial and satellite',
        'Focus: closing coverage gaps for rural/remote communities and maintaining emergency service communications',
        'Part of Vodafone\'s global vision as leader in commercial D2D satellite mobile connectivity in Europe',
        'SCE and Vodafone to work with EU institutions for harmonised European D2D framework and simplified authorisation',
        'Nedim Baytorun (CEO Vodafone Romania): "efforts to connect Romania and Romanians"',
        'Meredith Sharples (SCE MD): "European operators have growing confidence in Satellite Connect Europe"',
        'Supports European Digital Decade objectives and crisis response resilience',
      ],
      sources: ['Vodafone Romania / Satellite Connect Europe Press Release Mar 2, 2026'],
      prevValue: 'No Vodafone Romania-specific SCE engagement',
      newValue: 'Vodafone Romania SCE partnership with summer 2026 D2D trial services in Romania',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
      category: 'Earnings',
      title: 'Q4 2025 Business Update — $54.3M Revenue, $1B 2027 Target, $3.9B Liquidity',
      summary: 'Q4 rev $54.3M (+268% seq, beat consensus $42M). FY2025 $70.9M. 2026 guidance $150-200M. 2027 target $1B. Pro forma liquidity ~$3.9B funds 100+ sats.',
      details: [
        'Q4 2025 revenue: $54.3M (+268% seq) — beat consensus $42M. Driven by gov revenue + 15 gateway deliveries across 9 MNOs',
        'FY 2025 revenue: $70.9M — hit high end of $63-71M guidance range',
        '2026 guidance: $150-200M revenue. ~Half already contracted. Performance driven by gov services + gateway sales. Excludes commercial service activation',
        '2027 target: Revenue approaching $1B driven by SpaceMobile service activation. Management also cited "billions of annual revenue potential" for government use cases',
        'Commercial backlog grew to $1.2B ($1B prior). Annual revenue from commitments ~$100-300M range',
        'Pro forma liquidity: ~$3.9B — funds construction and launch of first 100+ satellites',
        'Q4 capex: $407M (above $275-325M guidance due to accelerated satellite material purchases and launch payment timing)',
        'Q1 2026 guidance: Adj opex $70-80M, capex $350-425M (launch payment timing)',
        'BB7 encapsulated, launching March. BB8-29 in various production stages. 3rd Block 2 payload: multiple satellites, shipping April',
        'Launch cadence: every 1-2 months avg. Future launches post-BB7: 3, 4, 6, 8 sats per launch. 45 sats in orbit by YE26, 60 built/ready to ship',
        '~12 contracted launches across 3 providers. New heavy launch vehicle agreement signed (standby)',
        'Production rate: 6 sats/month for microns and phased arrays (exited 2025). Integration/assembly/testing reaching 6/month by mid-2026',
        'ASIC chip integrating into Block 2 during 1H26: 10 GHz processing power, speeds >120 Mbps',
        'Long-term: high operating leverage with flow-through margins ~90%',
        'Beta trials: North America carriers (AT&T, VZ, Bell Canada) may commence after 25 sats in orbit — targeting late summer',
      ],
      sources: ['Q4 2025 Business Update Call (Mar 2, 2026)', 'William Blair Mar 3', 'UBS Mar 3', 'Roth Mar 3', 'BofA Mar 3'],
      prevValue: 'FY 2025 preliminary: $63-71M rev range. Contracted revenue $1B. Cash $2.78B.',
      newValue: 'FY 2025 actual: $70.9M (Q4 $54.3M). 2026 guide $150-200M. 2027 target $1B. Backlog $1.2B. Pro forma $3.9B. BB7 March.',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
      category: 'Partnership',
      title: 'CK Hutchison Group Telecom Partners with SCE for D2D in 5 European Markets — Summer 2026 Demos',
      summary: 'CKHGT partnership agreement with SCE to deploy D2D in Austria, Denmark, Ireland, Italy, and Sweden; field demos in Austria and Italy summer 2026',
      details: [
        'Partnership agreement with Satellite Connect Europe for 5 European markets: 3 Austria, 3 Denmark, 3 Ireland, WINDTRE Italy, 3 Sweden',
        'Field demonstrations to begin summer 2026 in Austria and Italy',
        'Integration of satellite capability directly into existing 4G and 5G networks — seamless automatic switching between terrestrial and satellite',
        'Closes long-standing coverage gaps, improving safety, rural/remote communities, emergency services during severe weather and crises',
        'CKHGT and SCE will work with EU institutions and Member States to develop harmonised European D2D framework including simplified authorisation process',
        'Francesco Zampini (IOD Director): "landmark agreement… SCE approach ensures we are in full control of the customer experience"',
        'SCE MD Meredith Sharples: "growing alignment behind a European direct-to-device satellite service proves the value of the approach"',
        '3 Ireland is separate from existing Vodafone Ireland SCE partnership — validates multi-operator open-access model in single market',
        'CKHGT operates 3 brand in UK, Italy (WINDTRE), Sweden, Denmark, Austria, Ireland; also majority interest in HTHKH (Hong Kong)',
        'Largest multi-market SCE partnership announced to date — 5 markets in single agreement',
      ],
      sources: ['CK Hutchison Group Telecom / SCE Press Release Mar 2, 2026'],
      prevValue: 'No CK Hutchison engagement with SCE',
      newValue: 'CKHGT partnership agreement for 5 European markets with summer 2026 demos in Austria and Italy',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
      category: 'Partnership',
      title: 'Vodafone Ukraine Signs MoU with AST SpaceMobile for LEO Satellite Broadband Across Ukraine',
      summary: 'MoU for high-capacity space-based cellular broadband network across Ukraine; full-service voice + data on standard smartphones',
      details: [
        'MoU signed at MWC Barcelona for high-capacity space-based cellular broadband across Ukraine via ASTS LEO constellation',
        'Shift from basic satellite messaging to full-service digital experience: broadband voice + data + SMS',
        'High-speed LEO broadband capable of enterprise applications, streaming, and web browsing',
        'Native real-time, low-latency voice calls directly on standard smartphones without additional hardware or apps',
        'National resilience: critical communication layer ensuring connectivity regardless of ground conditions — directly relevant to Ukraine\'s infrastructure challenges',
        'Seamless 3GPP transition between terrestrial towers and LEO satellites using standard mobile devices',
        'CEO Olga Ustynova: "no-compromise connectivity experience… high-speed LEO satellite solution even in the most remote locations or under challenging circumstances"',
        'Scott Wisniewski (ASTS President): "ensuring that connectivity is never limited by geography, infrastructure, or circumstance"',
        'MoU establishes general framework for cooperation — not a binding commercial contract; subject to technical feasibility, definitive agreements, regulatory approvals',
        'Vodafone Ukraine is largest Ukrainian MNO (~17M subscribers)',
        'First ASTS partner MoU focused on national resilience/infrastructure continuity in an active conflict zone',
      ],
      sources: ['Vodafone Ukraine / AST SpaceMobile Joint Press Release Mar 2, 2026'],
      prevValue: 'No ASTS engagement with Ukrainian MNO',
      newValue: 'Vodafone Ukraine MoU for LEO satellite broadband — new market, resilience use case',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
      category: 'Partnership',
      title: 'Telefónica Explores D2D Satellite Connectivity with Satellite Connect Europe for Spain and Germany',
      summary: 'Telefónica engaging with SCE to explore D2D technologies and integration models for future broadband connectivity in Spain and Germany',
      details: [
        'Telefónica engaging with Satellite Connect Europe to explore D2D satellite connectivity in Spain and Germany',
        'Focus: evaluating additional D2D technologies, integration models, and use cases for future broadband connectivity needs',
        'Analysing how D2D satellite capabilities could integrate with Telefónica\'s existing 4G and 5G networks',
        'Objective: complementing terrestrial connectivity and enhancing network resilience in remote areas or exceptional circumstances',
        'Operator-managed experience maintained — aligns with SCE open-access model',
        'Telefónica supports European regulatory frameworks and spectrum usage requirements for satellite D2D',
        'Andrea Folgueiras (Global CTIO): "deepen understanding of how satellite connectivity can complement advanced mobile networks"',
        'SCE MD Meredith Sharples: "another significant step forward… leading operators\' growing alignment behind Satellite Connect Europe"',
        'Telefónica is world\'s 4th-largest telecom operator (~300M mobile subscribers, 12 markets in Europe and Latin America)',
        'Softer commitment than CKHGT or Vodafone Ukraine — "exploring" and "engaging" vs. "partnership agreement" or "MoU"',
        'Builds on Telefónica\'s continued involvement in satellite connectivity solutions',
      ],
      sources: ['Telefónica Press Room Mar 2, 2026'],
      prevValue: 'Telefónica in "Others (40+ MNOs)" unnamed MOU category',
      newValue: 'Telefónica elevated to named SCE engagement for Spain and Germany; exploratory phase',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
      category: 'Partnership',
      title: 'Orange Signs MOU with AST SpaceMobile and Satellite Connect Europe for D2D Broadband',
      summary: 'Orange MOU with both ASTS and SCE for D2D technology collaboration in relevant Orange markets; Romania demo planned H2 2026',
      details: [
        'MOU signed with both AST SpaceMobile and Satellite Connect Europe (Vodafone-ASTS JV) for D2D in relevant Orange markets',
        'D2D demonstration in Romania covering voice, SMS, and data planned H2 2026',
        'Collaboration includes exploring European security requirements and integration into Orange-managed Core Network',
        'Orange CEO Christel Heydemann: "Direct-to-Device satellite connectivity is an essential complement to our mobile networks, ensuring 100% connectivity"',
        'Orange is world\'s 4th largest telecom operator (310M customers, 26 countries, €40.3B 2024 revenue)',
        'Orange already launched Skylo SMS service in France Dec 2025 — ASTS MOU adds broadband D2D capability (voice + data + SMS vs SMS-only)',
        'Aligns with Orange "Trust the future" strategic plan',
        'Abel Avellan: "Together with Orange, we are advancing space-based cellular broadband to support seamless connectivity for everyday smartphones"',
      ],
      sources: ['Orange Press Release Mar 2, 2026'],
      prevValue: 'Orange in "Others (45+ MNOs)" MOU category',
      newValue: 'Orange upgraded to actively engaged D2D broadband partner with named Romania demo timeline',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
      category: 'Partnership',
      title: 'Taiwan Mobile Signs LEO Satellite D2D Strategic Cooperation Memorandum with AST SpaceMobile',
      summary: 'Taiwan Mobile signed Strategic Cooperation Memorandum for LEO D2D services at MWC 2026; focus on mountainous terrain, maritime, disaster response',
      details: [
        'Strategic Cooperation Memorandum for Low Earth Orbit Satellite Communication Services signed at MWC 2026',
        'Collaboration focuses on D2C (Direct-to-Cellular) technology using AST SpaceMobile BlueBird constellation',
        'Standard smartphones connect directly to satellites without hardware modification',
        'Use cases: remote mountainous areas, maritime, disaster response, emergency communications resilience',
        'Taiwan Mobile President Jamie Lin: advancing satellite-terrestrial integration roadmap',
        'Scott Wisniewski (ASTS President): "Taiwan is taking a forward-looking approach to communications resilience by integrating space-based cellular broadband into its national infrastructure"',
        'Taiwan\'s diverse topography (mountains, coast, offshore islands) and typhoon/earthquake belt creates strong D2D use case',
      ],
      sources: ['Taiwan Mobile Press Release Mar 2, 2026'],
      prevValue: 'No Asia-Pacific MNO engagement beyond Rakuten (Japan)',
      newValue: 'Taiwan Mobile MOU expands ASTS geographic reach into Asia-Pacific; new market with strong D2D terrain use case',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
      category: 'Partnership',
      title: 'VodafoneThree Signs Commercial Agreement with Satellite Connect Europe for UK D2D Trials',
      summary: 'SCE commercial agreement with VodafoneThree (merged Vodafone UK + Three UK) for live customer trials summer 2026',
      details: [
        'Commercial agreement (not MOU) — strongest commitment level among MWC 2026 announcements',
        'VodafoneThree is merged Vodafone UK + Three UK entity — UK\'s largest mobile operator by subscribers (~27M)',
        'Live customer trials set to start summer 2026',
        'D2D capability covers data, voice, and SMS via integration with existing 4G and 5G networks',
        'Standard smartphones connect directly to satellite in areas with no mobile coverage',
        'Andrea Donà (Chief Network Officer): "committed to connecting our customers in every nation, every community, and in every corner of the UK"',
        'SCE MD Meredith Sharples: "VodafoneThree is making a huge step forward with this partnership"',
        'Initiative will support development of harmonised European D2D regulatory framework and simplified authorisation process',
      ],
      sources: ['Satellite Connect Europe Press Release Mar 2, 2026'],
      prevValue: 'No UK-specific commercial D2D agreement',
      newValue: 'VodafoneThree commercial agreement with live UK customer trials summer 2026; supports EU 2GHz MSS harmonisation',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
      category: 'Partnership',
      title: 'Sunrise Commences D2D Satellite Demonstration with Satellite Connect Europe in Switzerland',
      summary: 'Sunrise evaluating open-access D2D satellite integration with existing 4G/5G networks in Switzerland via SCE',
      details: [
        'Sunrise working with SCE to evaluate how open access D2D satellite connectivity can complement terrestrial networks in Switzerland',
        'Demonstration evaluating integration of satellite capabilities with Sunrise\'s current 4G and 5G networks',
        'Smartphones transition between mobile and satellite signals in areas with limited or no coverage',
        'SCE approach ensures European-operated access with data sovereignty',
        'Sunrise is independent MNO (not Vodafone subsidiary) — validates SCE open-access model beyond Vodafone family',
        'Switzerland is not EU but important European market with challenging Alpine terrain ideal for D2D',
        'SCE MD Sharples: "Our work with Sunrise will showcase the role that our European-operated access to direct-to-device satellite service can play in providing ubiquitous mobile broadband coverage"',
      ],
      sources: ['Satellite Connect Europe Press Release Mar 2, 2026'],
      prevValue: 'SCE open-access model announced but no non-Vodafone MNO engagement confirmed',
      newValue: 'Sunrise (independent MNO) validates SCE open-access model; Alpine terrain demo underway',
      impact: 'Positive',
    },
    {
      date: '2026-03-02',
      category: 'Partnership',
      title: 'Vodafone Ireland Partners with SCE for Ireland\'s First D2D Satellite Broadband Video Call',
      summary: 'Vodafone Ireland partnership with SCE; secured Ireland\'s first D2D Test and Trial licence; preparing first satellite broadband video call',
      details: [
        'Vodafone Ireland partnered with Satellite Connect Europe for D2D satellite mobile broadband',
        'Preparing Ireland\'s first D2D satellite mobile broadband video call to a standard smartphone',
        'Vodafone secured Ireland\'s first Test and Trial licence for satellite D2D',
        'Integration of satellite capability into existing 4G/5G networks — smartphones switch automatically between terrestrial and satellite signals',
        'Focus: closing coverage gaps, safety, rural/remote communities, emergency services during severe weather and cross-border crises',
        'Vodafone Ireland supports harmonised European D2D framework with simplified authorisation',
        'Sheila Kavanagh (Network Director): "critical, resilient technology that will have a fundamental impact on how we communicate"',
        'SCE MD Sharples: "Vodafone Ireland\'s ambition will deliver a world-leading connectivity experience"',
      ],
      sources: ['Satellite Connect Europe Press Release Mar 2, 2026'],
      prevValue: 'No Irish D2D satellite test licence or trial',
      newValue: 'Ireland\'s first D2D Test and Trial licence secured; video call capability (full broadband) in preparation',
      impact: 'Positive',
    },
    {
      date: '2026-02-27',
      category: 'Partnership',
      title: 'Satellite Connect Europe Formally Launches — SatCo JV Rebranded with Leadership Team and Ground Infra',
      summary: 'SatCo JV rebranded as Satellite Connect Europe with full executive team and 5 European ground stations under construction',
      details: [
        'SatCo JV (Vodafone-ASTS) formally rebranded to "Satellite Connect Europe" (SCE)',
        'Headquarters remains Luxembourg; European-owned and operated',
        'Chairman: John Slamecka (ex-AT&T Business International President)',
        'Managing Director: Meredith Sharples (ex-Digicel Caribbean CEO)',
        'Board Director: Darren Ennis (Vodafone Group EU Affairs Director)',
        'Head of Finance: Florian Wopfner (ex-Docler Holding Group CFO)',
        'General Counsel: Beki Muinde (ex-Helios Towers plc)',
        'Head of Sales: Daniel Thomas (from Vodafone Group)',
        '5 European ground stations progressing — build underway in Spain and UK, 3 more locations finalising',
        'Open access D2D broadband provider for European MNOs — exclusive European access to ASTS LEO constellation',
        'Formerly SatCo JV (Nov 2025): Germany ops centre near Munich or Hannover; "command switch" for TTC/service encryption and beam control; PPDR bands 698–703/753–758 MHz and 733–736/788–791 MHz; candidate for EU 2GHz MSS spectrum',
        'CCS Insight Ben Wood: "one of the biggest leaps forward for coverage in decades"',
      ],
      sources: ['Vodafone PR Feb 27, 2026', 'Satellite Connect Europe PR Feb 27, 2026'],
      prevValue: 'SatCo JV announced (Jun 2025), Germany ops centre selected (Nov 2025)',
      newValue: 'Satellite Connect Europe launched with full leadership team, 5 ground stations under construction, open access model for European MNOs',
      impact: 'Positive',
    },
    {
      date: '2026-02-23',
      category: 'Government',
      title: 'SDA $30M HALO Europa Track 2 Prime Contract — AST SpaceMobile USA Defense Subsidiary',
      summary: '$30M Other Transaction agreement with Space Development Agency for Europa Track 2 Commercial Solutions under HALO program',
      details: [
        '$30M total contract value via Other Transaction (OT) agreement with SDA',
        'Europa Track 2 Commercial Solutions under HALO (Hybrid Acquisition for proliferated LEO) program',
        'First-ever prime contract supported by AST SpaceMobile USA, a wholly owned defense subsidiary',
        'Chris Ivory named CEO of AST SpaceMobile USA (previously known as CCO of parent)',
        'Demonstrates resilient, low-latency tactical satellite communications directly to government end devices',
        'Software-defined "bent-pipe" architecture for high-bandwidth data transport from LEO',
        'On-orbit demonstrations to validate integration with existing tactical military radios',
        'Delivers data products as-a-service to the Space Development Agency',
        'Supports DoD vision for resilient, hybrid architectures including PWSA',
        'Cumulative government contract value now $93M+ (SDA $43M + DIU $20M + SDA Europa $30M)',
      ],
      sources: ['Press Release Feb 23, 2026', 'businesswire.com'],
      prevValue: '8-9 government contracts, $63M+ cumulative value',
      newValue: '10 government contracts, $93M+ cumulative value. AST SpaceMobile USA defense subsidiary disclosed.',
      impact: 'Positive',
    },
    {
      date: '2026-02-20',
      category: 'Capital',
      title: '$75M Greenshoe Exercised — Total 2.25% Convertible Notes Now $1.075B',
      summary: 'Initial purchasers exercised $75M of $150M greenshoe option; total 2.25% notes outstanding: $1,075,000,000',
      details: [
        'Feb 19: Initial purchasers notified exercise of $75M additional notes option (50% of $150M available)',
        'Feb 20: Company consummated sale of $75M Option Notes to initial purchasers',
        'Option Notes have same terms and are issued under same Feb 17, 2026 indenture',
        'Total outstanding: $1,075,000,000 aggregate principal amount',
        'Maximum shares on conversion: 11,091,528 at initial max conversion rate of 10.3177 shares/$1K',
        'Items covered: 2.03 (Direct Financial Obligation), 3.02 (Unregistered Sales), 8.01',
        'Freshfields US LLP legal opinions (Exhibits 5.1, 5.2) for prospectus supplement shares',
        'Net additional proceeds: ~$73.8M (after discounts/commissions)',
      ],
      sources: ['8-K Feb 20, 2026'],
      prevValue: '$1B 2.25% notes outstanding; $150M greenshoe pending',
      newValue: '$1.075B 2.25% notes outstanding; $75M of $150M greenshoe exercised. Max conversion shares: 11.1M.',
      impact: 'Neutral',
    },
    {
      date: '2026-02-23',
      category: 'Capital',
      title: 'Registered Direct Settlements & $296.5M Notes Repurchases Completed',
      summary: 'Both registered direct offerings settled and concurrent notes repurchases completed on Feb 20 and Feb 23',
      details: [
        'Feb 20: RD#1 settled — 1,862,741 shares at $96.92; $46.5M 4.25% notes repurchased for ~$180.5M',
        'Feb 23: RD#2 settled — 4,475,223 shares at $96.92; $250M 2.375% notes repurchased for ~$433.7M (incl. accrued interest)',
        'Both funded by concurrent registered direct offerings + cash on hand',
        'Separate, privately negotiated repurchase transactions with limited holders',
        '4.25% notes: ~$3.5M remaining outstanding (from $460M original)',
        '2.375% notes: $325M remaining outstanding (from $575M original)',
        'Filing references Feb 11, 2026 prospectus supplements and Sep 5, 2024 shelf (File No. 333-281939)',
        'Signed by Andrew M. Johnson, EVP, CFO and CLO',
      ],
      sources: ['8-K Feb 23, 2026'],
      prevValue: 'RDs priced Feb 11, 424B5s filed Feb 13 — settlements pending',
      newValue: 'All Feb 2026 capital transactions fully settled. RD#1 Feb 20, RD#2 Feb 23.',
      impact: 'Neutral',
    },
    {
      date: '2026-02-17',
      category: 'Capital',
      title: '$1B Convertible Notes Indenture Completed — Settlement & Material Definitive Agreement',
      summary: 'Formal completion of $1B 2.25% Convertible Senior Notes due 2036; Indenture executed with U.S. Bank Trust Co.',
      details: [
        'Indenture dated Feb 17, 2026 between AST SpaceMobile and U.S. Bank Trust Company, National Association (trustee)',
        'Net proceeds: ~$983.7M after discounts, commissions, and offering expenses',
        'Conversion rate: 8.5982 shares/$1,000 (initial conversion price ~$116.30; 20% premium over Feb 11 close)',
        'Max shares on conversion: 11,865,355 (at max rate 10.3177 including make-whole adjustment)',
        '$150M greenshoe option through Feb 20, 2026 — NOT included in Feb 17 settlement',
        'Maturity: Apr 15, 2036. Interest: 2.25% semi-annually on Apr 15 & Oct 15 (first payment Oct 15, 2026)',
        'Convertible at holder option under three conditions: (1) 130% trading price trigger, (2) trading price <98% of conversion value, (3) corporate events',
        'Company may settle in cash, Class A shares, or combination at its election',
        'No call/redemption option before maturity. No sinking fund.',
        'Use of proceeds: spectrum deployment, AI/commercial opportunities, government space, debt reduction',
        'Item 1.01 (Material Definitive Agreement), Item 2.03 (Direct Financial Obligation), Item 3.02 (Unregistered Sales), Item 8.01 (pricing press releases)',
        'Cross-default threshold: $50M indebtedness',
      ],
      sources: ['8-K Feb 17, 2026', 'Indenture (Exhibit 4.1)', 'Form of Global Note (Exhibit 4.2)'],
      prevValue: '$1B notes priced Feb 11 (8-K), pending settlement',
      newValue: '$1B 2.25% notes settled Feb 17. Indenture executed. ~$983.7M net proceeds received.',
      impact: 'Neutral',
    },
    {
      date: '2026-02-17',
      category: 'Corporate',
      title: 'Vodafone SC 13D/A (Amendment No. 3): Dropped Below 5% Threshold',
      summary: 'Vodafone Ventures/Vodafone Group Plc holdings unchanged at 14.5M shares but diluted below 5% by share issuances',
      details: [
        'Vodafone Ventures Ltd + Vodafone Group Plc (joint filers)',
        'Total beneficial ownership: 14,516,197 shares (5,471,743 Class A + 9,044,454 AST Common Units)',
        'Also holds 9,044,454 shares of Class B Common Stock (forfeited 1:1 upon LLC Unit redemption)',
        'Percent of class: 5.0% (based on 277,628,960 Class A outstanding as of Nov 6, 2025)',
        'Ceased to be >5% beneficial owner due to increase in outstanding shares, NOT from sales',
        'No transactions by Reporting Persons in past 60 days',
        'Event date: Jan 29, 2026. Filed: Feb 17, 2026.',
        'LLC Units exchangeable 1:1 for Class A or, at Issuer election, cash based on Class A value',
      ],
      sources: ['SC 13D/A Feb 17, 2026 (Amendment No. 3)'],
      prevValue: 'Vodafone: 14.5M shares, ~6% (per Mar 12, 2025 13D/A Amend. No. 2)',
      newValue: 'Vodafone: 14.5M shares, ~5% — diluted below threshold by new share issuances',
      impact: 'Neutral',
    },
    {
      date: '2026-02-11',
    ...
    },
    {
      date: '2025-05-13',
      category: 'Capital',
      title: '$500M Equity Distribution Program (ATM)',
      summary: '$500M ATM via B. Riley et al. Used ~$287M before Oct termination when replaced by $800M program.',
      details: [
        '$500M Class A shares via equity distribution agreement',
        'Agents: B. Riley Securities and others',
        'Fee: $76,550',
        'At-the-market sales at prevailing prices',
        'Used ~$287M through Q3 2025',
        'Terminated Oct 2025 when replaced by $800M ATM program',
        'Potential dilution at launch: ~15% of market cap at $32.50',
      ],
      sources: ['424B5 filed May 13, 2025'],
      prevValue: 'Prior ATM facilities expired/terminated',
      newValue: '$500M new ATM capacity; ~$287M utilized',
      impact: 'Neutral',
    },
    {
      date: '2025-04-28',
      category: 'Corporate',
      title: 'BlackRock 13G/A: 5.2% Stake (14.86M shares)',
      summary: 'BlackRock increased to 5.2% beneficial ownership as of 3/31/2025. Sole voting/dispositive.',
      details: [
        'Beneficial ownership: 14,858,926 Class A shares (~5.2%)',
        'Sole voting power: 14,858,926 shares',
        'Sole dispositive power: 14,858,926 shares',
        'Up from ~4% prior filing',
        'Value: ~$430M at April close ($29.50)',
        'Subsidiaries: BlackRock Advisors, Fund Managers, etc.',
        'Passive institutional holding adds stability',
      ],
      sources: ['SC 13G/A filed Apr 28, 2025 (as of Mar 31, 2025)'],
      prevValue: '~4% BlackRock ownership',
      newValue: '5.2% (14.86M shares)',
      impact: 'Positive',
    },
    {
      date: '2025-04-25',
      category: 'Corporate',
      title: 'DEF 14A Proxy + Annual Report (ARS)',
      summary: 'Proxy for Jun 6 annual meeting: directors, 2024 incentive plan (5.4M shares), auditors. ARS with CEO letter.',
      details: [
        'DEF 14A filed Apr 25 (PRE 14A filed Apr 14)',
        'Annual meeting: June 6, 2025',
        'Proposal 1: Election of directors',
        'Proposal 2: 2024 Equity Incentive Plan (5.4M shares, ~2% dilution)',
        'Proposal 3: Ratification of independent auditors',
        'CEO compensation: $1M salary + equity grants',
        'Avellan ownership: ~28%',
        'ARS: CEO letter emphasizes constellation progress, partnerships (AT&T/Verizon)',
        'DEFA14A supplemental materials also filed',
      ],
      sources: ['DEF 14A Apr 25, 2025', 'PRE 14A Apr 14, 2025', 'ARS Apr 25, 2025', 'DEFA14A Apr 25, 2025'],
      prevValue: 'Prior year governance approved',
      newValue: '5.4M share plan + directors for FY2025',
      impact: 'Neutral',
    },
    {
      date: '2025-04-04',
      category: 'Corporate',
      title: 'Director + CFO Open Market Purchases at $25',
      summary: 'Cisneros (Dir) bought 1K shares, Johnson (CFO) bought 500 shares at $25 — continued dip buying',
      details: [
        'Adriana Cisneros (Director): 1,000 shares at $25.00 via trusts (indirect). Post: 782,327 shares.',
        'Andrew M. Johnson (CFO): 500 shares at $25.00 via IRA. Post: 500 shares. Form 4/A corrected Apr 9.',
        'Total purchases: ~$37.5K',
        'Context: Stock at $25 range (Apr 2025 low)',
        'Part of a pattern: Cisneros also bought May 7, Jun 9, Jun 24 at $25',
        'Johnson also bought Jun 24 at $25',
      ],
      sources: ['Form 4 (Cisneros) Apr 4, 2025', 'Form 4/A (Johnson) Apr 9, 2025'],
      prevValue: 'No recent insider buys',
      newValue: 'Director + CFO buying at $25 dip (Apr 4)',
      impact: 'Positive',
    },
    {
      date: '2025-03-24',
      category: 'Regulatory',
      title: 'Ligado Material Agreement (8-K)',
      summary: '$150M initial investment for 45 MHz L-band spectrum access; warrants for 9.99% AST stake',
      details: [
        '8-K: Entry into Material Definitive Agreement with Ligado Networks',
        '$150M initial investment for up to 45 MHz spectrum (US & Canada)',
        'Warrants for 9.99% AST stake (~22M shares, ~$120M value at time)',
        '$80M annual lease payments + revenue sharing',
        '$550M total consideration tied to Ligado Chapter 11 bankruptcy plan',
        'Spectrum: 40 MHz L-band (1525-1559 MHz) + 5 MHz (1670-1675 MHz)',
        'Formalizes RSA announced Jan 6, 2025',
        '+10% intraday on announcement (Mar 24)',
        'Risks: FCC regulatory approvals, bankruptcy court outcomes',
      ],
      sources: ['8-K Mar 24, 2025'],
      prevValue: 'RSA announced Jan 6 (non-binding)',
      newValue: 'Definitive agreement: $150M + 9.99% warrants + $550M total',
      impact: 'Positive',
    },
    {
      date: '2025-03-17',
      category: 'Capital',
      title: 'S-3ASR: 56M Shares Registered for Resale',
      summary: 'Automatic shelf registration for 56M shares (~25% dilution potential), primarily Rakuten reorganization',
      details: [
        'S-3ASR automatic shelf registration: 56,071,233 Class A shares',
        '28.5M shares from Rakuten reorganization',
        '~1.7M exchangeable shares + others',
        'Aggregate value ~$1.6B (at $28.62/share for fee calc)',
        'Facilitates secondary sales by existing holders',
        'No immediate issuance — overhang risk',
        'Registration fee: $245,689',
      ],
      sources: ['S-3ASR Mar 17, 2025'],
      prevValue: 'Limited secondary liquidity',
      newValue: '56M shares registered for resale (~25% potential)',
      impact: 'Neutral',
    },
    {
      date: '2025-03-10',
      category: 'Corporate',
      title: 'March 2025 Insider Sales: ~111K Shares ($3.4M)',
      summary: 'Five insiders sold/withheld ~111K shares for RSU tax purposes; avg ~$30.60/share post-earnings',
      details: [
        'Rubin (Dir): 7K sold at $32.46 on Mar 10 (post: 65,628)',
        'Torres (Dir): 20K sold at $30.73 avg on Mar 10 (post: 52,628)',
        'Wisniewski (Pres): 23,643 withheld at $28.15 (Mar 15) + 35,871 sold at $28.35 (Mar 17). Post: 653,146',
        'Gupta (COO): 24,425 sold at $28 on Mar 17 (post: 368,807)',
        'Bernal (CAO): 3,244 withheld at $25.71 on Mar 21 (post: 120,335)',
        'Total: ~111K shares, ~$3.4M proceeds at avg ~$30.60',
        'All RSU vesting-related (tax withholding + dispositions)',
        'Context: Stock peaked $35.49 (Mar 6) after +18% Q4 earnings pop, fell to $22.74 by EOM',
        'X sentiment mixed: bearish on "executives cashing out," but routine compensation liquidity',
      ],
      sources: ['Form 4s Mar 10-24, 2025', 'Form 144s Mar 10-18, 2025'],
      prevValue: 'No March insider transactions',
      newValue: '~111K shares sold/withheld by 5 insiders ($3.4M)',
      impact: 'Neutral',
    },
    {
      date: '2025-04-28',
    ...
    },
    {
      date: '2025-02-27',
      category: 'Corporate',
      title: 'Bernal (CAO) 50K RSU Grant',
      summary: '50,000 RSUs granted to CAO Maya Bernal, vesting Feb 15, 2026',
      details: [
        '50,000 RSU grant to Maya Bernal (Chief Accounting Officer)',
        'Cliff vest: Feb 15, 2026',
        'Estimated value ~$1.5M at $30/share',
        'Retention/alignment grant during growth phase',
      ],
      sources: ['Form 4 Feb 27, 2025'],
      prevValue: 'Bernal compensation via salary',
      newValue: '50K RSU grant (vest Feb 2026)',
      impact: 'Neutral',
    },
    {
      date: '2025-02-10',
      category: 'Partnership',
      title: 'AT&T Files 13D: 2.7% Ownership (6.26M Shares)',
      summary: 'AT&T discloses 2.7% beneficial ownership from $100M convertible note; stockholders\' agreement amended to add AT&T',
      details: [
        'SC 13D + Form 3 filed Feb 10, 2025',
        'AT&T beneficially owns 6,260,440 Class A shares (2.7%)',
        'Shares acquired via AT&T Venture Investments, LLC (subsidiary)',
        'From $100M convertible note investment (Jan 2024) at $16/share',
        'Stockholders\' agreement amended Feb 7 to add AT&T as party',
        'AT&T gains board designee rights if stake exceeds 10%',
        '+5% stock move on filing day',
        'Part of 10% group via stockholders\' agreement (disclaims broader ownership)',
      ],
      sources: ['SC 13D Feb 10, 2025', 'Form 3 Feb 10, 2025', '8-K Feb 7, 2025'],
      prevValue: 'AT&T as MNO partner only',
      newValue: 'AT&T 2.7% owner + governance party + designee rights',
      impact: 'Positive',
    },
    {
      date: '2025-02-03',
      category: 'Corporate',
      title: 'Johnson (CFO/CLO) Appointed to Board + Larson Director',
      summary: 'Andrew Johnson appointed Class II director (Feb 3); Keith Larson appointed (Jan 31)',
      details: [
        'Andrew M. Johnson: CFO & CLO, appointed to Board as Class II director (8-K Feb 3)',
        'Term expiring 2025. No arrangements for appointment.',
        'Background: Former 3D Systems executive. Legal/finance expertise.',
        'Keith R. Larson: Appointed director effective Jan 31, 2025 (Form 3 filed Feb 28)',
        'Zero initial share ownership. Later purchased 675 shares at $69.55 (Dec 2025).',
        'Both appointments strengthen governance for growth phase.',
      ],
      sources: ['8-K Feb 3, 2025', 'Form 3 Feb 28, 2025'],
      prevValue: 'Prior board composition',
      newValue: 'Johnson + Larson added to board',
      impact: 'Positive',
    },
    {
      date: '2025-01-22',
      category: 'Earnings',
      title: 'Preliminary Q4 2024 Results (8-K)',
      summary: 'First-ever revenue $1M, net loss $61.7M, cash $285M. +10% stock reaction.',
      details: [
        'Q4 2024 revenue: $1.0M (up from $0 prior year) — first commercial revenue',
        'Q4 2024 net loss: $61.7M (vs $20.1M prior year)',
        'FY2024 net loss: $240M',
        'Cash position: $285M (end of Q4 2024)',
        'Non-GAAP adjusted opex: $40.8M (Q4)',
        'Cash burn ~$50M/quarter — liquidity supports 5-6 quarters operations',
        'Stock reaction: +10% on filing day',
        'X sentiment upbeat on "commercial traction" milestone',
      ],
      sources: ['8-K Jan 22, 2025'],
      prevValue: '$0 revenue (development stage)',
      newValue: '$1M Q4 revenue (first ever), $285M cash',
      impact: 'Positive',
    },
    {
      date: '2025-03-03',
