...
export const ASTS_FILING_CROSS_REFS: Record<string, { source: string; data: string }[]> = {
  ...
  // ── Feb 2026 ──────────────────────────────────────────────────────────────
  '8-K|2026-02-11': [
    { source: 'capital', data: "$1B converts at 2.25% due 2036. Conversion rate 8.5982/share per $1K. UBS lead. $150M greenshoe." },
  ...
  '424B5|2026-02-13': [
    { source: 'capital', data: "Registered Direct #1: 1,862,741 shares at $96.92. Funded $46.5M 4.25% notes repurchase." },
    { source: 'capital', data: "Registered Direct #2: 4,475,223 shares at $96.92. Funded $250M 2.375% notes repurchase." },
  ],

  // ── Jan 2026 ──────────────────────────────────────────────────────────────
  'SC 13G|2026-01-30': [
    { source: 'capital', data: "Vanguard Group: 21,488,180 shares, 7.68% of Class A (as of 12/31/2025)" },
  ],
  'Form 4|2026-01-26': [
    { source: 'capital', data: "Form 4/A: Gupta (COO) holdings correction — originally 398,232; corrected to 348,232" },
  ],
  '8-K|2026-01-16': [
  ...
  '8-K|2025-12-24': [
    ...
    { source: 'company', data: "block2Sats: 1 (BB6 launched Dec 23, 2025. Unfolded Feb 10, 2026)" },
    { source: 'quarterly-metrics', data: "satellites: 7 (BW3 + BB1-5 + BB6)" },
  ],
  'SC 13D/A|2025-12-11': [
    { source: 'capital', data: "American Tower: sold 2,288,621 shares at $69.75 via Barclays ($159.8M); 211K Class A remain + 2.17M LLC Units" },
  ],
  'Form 4|2025-12-10': [
    { source: 'capital', data: "Gupta (COO): 10K sold at $77.34 ($773K), post: 382,375. Larson (Dir): 675 purchased at $72.71" },
    { source: 'timeline', data: "COO Gupta 10K shares $773K; CAO Bernal 6K $443K; CTO Yao 40K $2.94M (Dec insider sales)" },
  ],
  'Form 4|2025-12-05': [
    { source: 'capital', data: "Bernal (CAO): 6K sold at $73.76 ($442K), post: 122,486. Yao (CTO): 40K at $73.52 ($2.94M)" },
  ],
  'Form 4|2025-12-02': [
    { source: 'capital', data: "DEC_2025_RSU_GRANTS: Avellan 250K, Johnson 125K, Wisniewski 125K — vest 1/3 annually from May 2026" },
  ],

  // ── Nov 2025 ──────────────────────────────────────────────────────────────
  '10-Q|2025-11-10': [
    { source: 'financials', data: "Q3 2025: cashAndEquiv: 1220.1, totalDebt: 697.6, revenue: 14.7, opEx: 94.4" },
    { source: 'quarterly-metrics', data: "satellites: 6 (BW3 + BB1-5), cash: $1,220.1M" },
  ],
  '8-K|2025-11-03': [
    { source: 'capital', data: "ubsLoan: 420  // Cash-collateralized for Ligado" },
    { source: 'financials', data: "totalDebt includes $420M UBS term loan" },
  ...
  'DEF 14A|2025-10-28': [
    { source: 'timeline', data: "Special meeting approved Amended 2024 Plan: +10M authorized shares, term extended" },
  ],
  '424B5|2025-10-23': [
    { source: 'capital', data: "Oct 2025 ATM Program: $800M capacity via B. Riley, Barclays; ~10.1M shares sold thru Feb 10" },
  ],
  '8-K|2025-10-21': [
  ...
  // ── Sep 2025 ──────────────────────────────────────────────────────────────
  '424B7|2025-09-26': [
    { source: 'timeline', data: "581K Class A shares from EllioSat S-Band acquisition registered for resale (~0.2% float)" },
  ],
  '8-K|2025-09-05': [
    { source: 'timeline', data: "Mikitani resigned from Board Sep 4 (personal; no disagreement). Separate from Jan 2026 Rakuten designee." },
    { source: 'catalysts', data: "Mikitani Resigned from Board (personal, no disagreement)" },
  ],
  'Form 4|2025-09-03': [
    { source: 'capital', data: "Yao (CTO): 40K sold at $41.58 ($1.66M). Gupta (COO): Sep 15 vesting 50K (25.6K tax withhold at $29.83)" },
  ],

  // ── Aug 2025 ──────────────────────────────────────────────────────────────
  'Form 4|2025-08-19': [
    { source: 'capital', data: "Aug 15 RSU vestings: Yao 50K (20K tax $690K), Johnson 80K (35K tax $1.2M), Gupta 50K (21K tax $725K). Avellan 500K RSU grant." },
  ],
  '10-Q|2025-08-11': [
  ...
  // ── Jul 2025 ──────────────────────────────────────────────────────────────
  '8-K|2025-07-29': [
    { source: 'timeline', data: "July 2025 Registered Direct ($347M, 5.78M shares at $60.06) + Q2 Preliminary Results" },
  ],
  '424B5|2025-07-28': [
    { source: 'capital', data: "5,775,635 shares at $60.06, ~$347M. Registered Direct for 4.25% notes repurchase." },
  ],
  'FWP|2025-07-25': [
    { source: 'capital', data: "Pricing Term Sheet: 5,775,635 shares at $60.06" },
  ],
  '424B5|2025-07-24': [
    { source: 'capital', data: "$1B converts at 2.375%, $575M principal, maturity 2032, $120.12 capped call strike" },
  ],
  '8-K|2025-07-18': [
    { source: 'capital', data: "JUL_2025_CREDIT_FACILITY: amount: 345, expandableTo: 500, rate: 'SOFR + 5%', lender: 'UBS'" },
    { source: 'catalysts', data: "$345M UBS Credit Facility (expandable $500M; SOFR+5%; maturity 2028)" },
  ],
  'SC 13D/A|2025-07-15': [
    { source: 'capital', data: "Avellan 13D/A (Amendment 14): 78,163,078 Class A equiv (~28%), no transactions in 60 days" },
  ],
  '8-K|2025-07-03': [
    { source: 'timeline', data: "Annual Meeting (Jun 27): Directors, Incentive Plan, Auditors Approved" },
  ],

  // ── Jun 2025 ──────────────────────────────────────────────────────────────
  'Form 4|2025-06-26': [
    { source: 'capital', data: "JUN_2025_INSIDER_PURCHASES: Cisneros 1K at $25; Johnson 500 at $25 — director confidence at dip" },
  ],
  '8-K|2025-06-09': [
    { source: 'capital', data: "JUN_2025_CERTIFICATE_AMENDMENT: Class A authorized increased from 700M to 800M (+100M)" },
  ],
  'Form 4|2025-06-09': [
    { source: 'capital', data: "Cisneros (Dir): 1K purchased at $25 (trust; post: 784,077)" },
  ],
  'Form 144|2025-06-09': [
    { source: 'capital', data: "Gupta proposed 10K sale; Wisniewski proposed 80K sale (via Fidelity)" },
  ],
  'Form 4|2025-06-03': [
    { source: 'capital', data: "Wisniewski 125K RSU grant (vest 1/3 annually from May 2026); Gupta 50K RSU vesting (20K tax w/h at $22.50)" },
  ],

  // ── May 2025 ──────────────────────────────────────────────────────────────
  'Form 4|2025-05-19': [
    { source: 'capital', data: "Yao (CTO): 40K option exercise at $0.06 ($2,400 total). Post: 240K LLC Units" },
  ],
  'Form 144|2025-05-16': [
    { source: 'capital', data: "Yao proposed 40K sale (~$1M at ~$25) via Fidelity. 10b5-1 plan Jun 12." },
  ],
  '424B5|2025-05-13': [
    { source: 'capital', data: "$500M Equity Distribution Program (ATM via B. Riley); used ~$287M before Oct termination" },
  ],
  '10-Q|2025-05-12': [
    { source: 'financials', data: "Q1 2025: cashAndEquiv: 874.5, revenue: 0.7, opEx: 63.7" },
  ],
  '8-K|2025-05-12': [
    { source: 'timeline', data: "Q1 2025 Earnings: Revenue $0.7M, adj. opex $44.9M, H2 Guidance $50-75M" },
  ],
  'Form 4|2025-05-07': [
    { source: 'capital', data: "APR_MAY_2025_INSIDER_PURCHASES: Cisneros 1K at $25 (post: 783,327)" },
  ],

  // ── Apr 2025 ──────────────────────────────────────────────────────────────
  'SC 13G/A|2025-04-28': [
    { source: 'capital', data: "BlackRock: 14,858,926 shares, 5.2% ownership (sole voting/dispositive, as of 3/31/2025)" },
  ],
  'DEF 14A|2025-04-25': [
    { source: 'capital', data: "Annual Meeting Jun 6; 2024 Equity Incentive Plan (5.4M shares, ~2% dilution). CEO $1M salary + equity." },
  ],
  'Form 4|2025-04-04': [
    { source: 'capital', data: "Cisneros 1K at $25 (post: 782,327); Johnson 500 at $25 (IRA; Form 4/A corrected Apr 9)" },
  ],

  // ── Mar 2025 ──────────────────────────────────────────────────────────────
  '8-K|2025-03-24': [
    { source: 'capital', data: "MAR_2025_LIGADO_DEAL: $150M initial + 9.99% warrants (~22M shares), $80M annual lease, 45 MHz L-band" },
    { source: 'catalysts', data: "Ligado Material Agreement ($150M + 9.99% warrants; $550M total; 45 MHz L-band)" },
  ],
  'Form 4|2025-03-24': [
    { source: 'capital', data: "Bernal (CAO): 3,244 shares withheld at $25.71 (RSU tax; net 9,256 vested)" },
  ],
  'Form 4|2025-03-17': [
    { source: 'capital', data: "Wisniewski 23,643 w/h + 35,871 sold at $28.35; Gupta 24,425 sold at $28 — RSU vesting sales" },
  ],
  'S-3ASR|2025-03-17': [
    { source: 'capital', data: "56,071,233 shares registered for resale (28.5M Rakuten reorg + others; ~25% dilution potential)" },
  ],
  'SC 13D/A|2025-03-12': [
    { source: 'capital', data: "Vodafone: 14.5M shares (6% ownership). 1M Class A + 4.47M convert + 9.04M Units/Class B. No change." },
  ],
  'Form 4|2025-03-10': [
    { source: 'capital', data: "Torres (Dir): 20K sold at $30.73; Rubin (Dir): 7K sold at $32.46 — RSU tax w/h sales" },
  ],
  'S-8|2025-03-05': [
    { source: 'timeline', data: "2M shares registered under 2024 Incentive Plan (annual increase; $52.6M at $26.29)" },
  ],
  '10-K|2025-03-03': [
    { source: 'financials', data: "Q4 2024: cashAndEquiv: 567.5, totalDebt: 155.6, revenue: 1.9, opEx: 60.6" },
    { source: 'financials', data: "FY 2024: Revenue $4.4M (first ever), OpEx $247.2M, net loss $240M" },
  ],

  // ── Feb 2025 ──────────────────────────────────────────────────────────────
  'Form 3|2025-02-28': [
    { source: 'capital', data: "Larson (Dir): initial ownership zero shares. Board appointment effective Jan 31." },
  ],
  '8-K|2025-02-27': [
    { source: 'timeline', data: "Q4 2024 Earnings: Revenue $1.9M, net loss $61.7M, cash $285M" },
  ],
  'Form 4|2025-02-27': [
    { source: 'capital', data: "Bernal (CAO): 50K RSU grant, vest Feb 15, 2026 (~$1.5M at $30/share)" },
  ],
  'SC 13D|2025-02-10': [
    { source: 'capital', data: "AT&T: 6,260,440 shares (2.7% ownership) from $100M convertible at $16/share" },
  ],
  '8-K|2025-02-07': [
    { source: 'capital', data: "Stockholders' Agreement amended to add AT&T as party; board designee rights if >10% stake" },
  ],
  '8-K|2025-02-03': [
    { source: 'capital', data: "JAN_FEB_2025_GOVERNANCE: Johnson (CFO/CLO) appointed to Board (Class II director)" },
  ],
  '8-K|2025-01-31': [
    { source: 'timeline', data: "Annual Meeting Notice: proposed May 6 (later moved to Jun 6); proposal deadline Feb 14" },
  ],

  // ── Jan 2025 ──────────────────────────────────────────────────────────────
  'SC 13D/A|2025-01-27': [
    { source: 'capital', data: "Avellan: 78,163,078 shares (25% ownership; Amendment 12). No sales." },
  ],
  '8-K|2025-01-22': [
    { source: 'timeline', data: "Preliminary Q4 2024: Revenue $1M (first ever), net loss $61.7M, cash $285M. +10% stock reaction." },
  ],
  '8-K|2025-01-06': [
  ...
  // ── 2024 ──────────────────────────────────────────────────────────────────
  '10-Q|2024-11-06': [
    { source: 'financials', data: "Q3 2024: per 10-Q. Block 1 operational, first commercial revenue imminent." },
  ],
  '8-K|2024-09-12': [
  ...
  '10-Q|2024-08-07': [
    { source: 'financials', data: "Q2 2024: per 10-Q" },
  ],
  '10-Q|2024-05-10': [
    { source: 'financials', data: "Q1 2024: per 10-Q. Gateway bookings $13.6M." },
  ],
  'S-3|2024-04-16': [
    { source: 'catalysts', data: "$500M ATM Shelf facility" },
  ],
  '10-K|2024-03-28': [
