...
export const ASTS_TIMELINE_EVENTS = [
    {
      ...
      title: 'MWC 2026: Orange MOU, Taiwan Mobile MOU, VodafoneThree Commercial Agreement, Sunrise Demo, Vodafone Ireland Partnership',
      summary: 'Wave of European and Asia-Pacific MNO announcements via Satellite Connect Europe and direct ASTS partnerships at MWC 2026',
      details: [
        'Orange MOU signed with both AST SpaceMobile and Satellite Connect Europe for D2D in relevant Orange markets',
        'Orange Romania D2D demonstration (voice, SMS, data) planned H2 2026',
        'Orange already launched Skylo SMS in France Dec 2025 — ASTS MOU adds broadband D2D capability',
        'Taiwan Mobile signed Strategic Cooperation Memorandum for LEO D2D at MWC 2026',
        'VodafoneThree (UK) signed commercial agreement with SCE — live customer trials summer 2026',
        'VodafoneThree commercial agreement is strongest commitment level among MWC announcements',
        'Sunrise (Switzerland) commenced D2D satellite demonstration with SCE — evaluating 4G/5G integration',
        'Vodafone Ireland partnered with SCE — preparing Ireland\'s first D2D satellite broadband video call',
        'Vodafone Ireland secured Ireland\'s first Test and Trial licence for satellite D2D',
        'All announcements feature full broadband D2D (voice, SMS, data) to standard unmodified smartphones',
      ],
      sources: ['Orange PR Mar 2, 2026', 'Taiwan Mobile PR Mar 2, 2026', 'Satellite Connect Europe PRs Mar 2, 2026'],
      prevValue: 'SCE launched Feb 27 with leadership team; European MNO engagement in progress',
      newValue: '5 new MNO partnerships/agreements at MWC: Orange (MOU), Taiwan Mobile (MOU), VodafoneThree (commercial), Sunrise (demo), Vodafone Ireland (partnership + trial licence)',
      impact: 'Positive',
    },
    {
      date: '2026-02-27',
    ...
    },
    {
      ...
      details: [
        ...
        'Germany selected for main Satellite Operations Centre (near Munich or Hannover, final negotiations)',
        'Planned EU constellation with "command switch" for EU oversight — TTC encryption, service encryption, beam activation/deactivation',
        'ITU filing for new mid-band constellation through Germany',
        '21 EU member states MNOs expressed interest',
        'PPDR (emergency services) capability planned — frequency bands 698–703/753–758 MHz and 733–736/788–791 MHz',
        'Candidate for EU 2GHz Mobile Satellite Services (MSS) spectrum',
        'Commercial launch from 2026',
        'Feb 2026 update: JV rebranded to "Satellite Connect Europe" (SCE) with full leadership team',
      ],
      sources: ['Press release Nov 7, 2025', 'Vodafone PR Feb 27, 2026 (SCE rebrand)'],
      prevValue: 'Commercial partnership only',
      newValue: 'JV with EU sovereign constellation → rebranded as Satellite Connect Europe Feb 2026',
      impact: 'Positive',
    },
    {
      date: '2025-10-31',
