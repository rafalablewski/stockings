...
export const agents: AgentNode[] = [
  ...
  {
    id: 'pm-research',
    name: 'Research & Thesis PM',
    role: 'Research Pipeline Manager',
    status: 'active' as const,
    phase: 'Continuous',
    matchers: ['Thesis Engineer', 'Capital Structure Engineer', 'Earnings Engineer'],
    description: 'Oversees the research pipeline — thesis pressure-testing, capital structure tracking, and earnings analysis. Manages 3 engineers on an hours-cadence cycle.',
    category: 'workflow' as const,
    color: 'mint',
    connections: ['earnings-call', 'methodology-sync'],
    files: [],
    prompts: [],
    metrics: { runsPerDay: 0 },
  },
  {
    id: 'pm-monitoring',
    name: 'Monitoring & Intel PM',
    role: 'Data Ingestion & Signals Manager',
    status: 'active' as const,
    phase: 'Continuous',
    matchers: ['SEC Filing', 'Press Intel', 'Insider Activity', 'Catalyst Tracker', 'Sentiment', 'Regulatory', 'General Intel'],
    description: 'Manages the real-time data ingestion funnel — SEC filings, press monitoring, insider tracking, catalyst detection, sentiment aggregation, and regulatory analysis. Manages 7 engineers on a minutes-to-hours cadence.',
    category: 'pipeline' as const,
    color: 'gold',
    connections: ['press-intel', 'methodology-sync', 'api-edgar', 'api-news'],
    files: [],
    prompts: [],
    metrics: { runsPerDay: 0 },
  },
  {
    id: 'pm-audit',
    name: 'Platform Audit PM',
    role: 'Quality & Security Manager',
    status: 'active' as const,
    phase: 'Continuous',
    matchers: ['Data Quality', 'Code Security', 'Performance', 'Disclosure'],
    description: 'Oversees platform quality and security — data integrity validation, code security audits, performance profiling, and disclosure completeness checks. Manages 4 engineers on a daily cadence.',
    category: 'workflow' as const,
    color: 'violet',
    connections: ['code-audit', 'code-review'],
    files: [],
    prompts: [],
    metrics: { runsPerDay: 0 },
  },
