...
export const TIMELINE_METADATA: DataMetadata = {
  ...
  source: 'Company press releases, SEC EDGAR, partner announcements',
...
export const TIMELINE: TimelineEntry[] = [
  // === 2026 ===
  { date: '2026-02-05', category: 'Partnership', event: 'Kraken Institutional announces first bespoke investment solution with Bitwise', impact: 'Institutional yield infrastructure', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken Institutional launched Bitwise Custom Yield Strategy, first bespoke yield solution for institutional clients. Delivered by Bitwise Asset Management within Kraken qualified custody, execution, and risk framework. Additional strategies and fund managers expected to follow.' },
  ...
  { date: '2025-10-22', category: 'Partnership', event: 'Kraken September 2025 Proof of Reserves includes USDC', impact: 'USDC verified in exchange reserves', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken Proof of Reserves attested as of September 30, 2025 covers USDC alongside BTC, ETH, SOL, USDT, XRP, ADA. Client assets verified 1:1 using Merkle tree proofs with independent third-party accountancy firm attestation.' },
  { date: '2025-10-16', category: 'Partnership', event: 'Kraken acquires CFTC-regulated Designated Contract Market', impact: 'Partner derivatives expansion', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken acquired Small Exchange, a CFTC-licensed DCM, from IG Group for $100M. Enables U.S.-native derivatives product suite. Follows prior NinjaTrader acquisition and Crypto Facilities (UK FCA MTF). Kraken now operates regulated derivatives venues in UK, EU, and US.' },
  { date: '2025-10-14', category: 'Expansion', event: 'USDC deposits and withdrawals live on Ink (Kraken L2)', impact: 'New chain for USDC', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken now supports USDC deposits and withdrawals on Ink, an Ethereum layer 2 blockchain built on the OP Stack. Ink is designed as the house of DeFi for the Superchain.' },
  { date: '2025-10-09', category: 'Partnership', event: 'Kraken launches CME futures contracts including crypto', impact: 'Expanded trading infrastructure', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken Derivatives US now supports CME futures contracts across crypto (BTC, ETH, SOL), equity indices, commodities, FX. Includes 0.5 bps fees and free L1 CME market data for funded non-professional clients.' },
  { date: '2025-10-09', category: 'Expansion', event: 'USDT deposits and withdrawals live on Aptos via Kraken', impact: 'Competitor stablecoin chain expansion', source: 'Kraken Blog', verdict: 'neutral', details: 'Kraken enabled USDT deposits and withdrawals on Aptos. USDT is the competing stablecoin by Tether. Aptos is a decentralized blockchain with parallel execution engine and modular design.' },
  { date: '2025-10-02', category: 'Expansion', event: 'Wallet in Telegram joins xStocks Alliance (100M+ users)', impact: 'Tokenized equities to Telegram users', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken and Backed partnered with Wallet in Telegram to bring xStocks to Telegram custodial wallet and self-custodial TON wallet. xStocks surpassed $4.5B in combined CEX and DEX volume. xStocks can be leveraged as collateral for DeFi protocols on TON.' },
  { date: '2025-09-23', category: 'Product', event: 'Kraken adds WLD and WLFI margin trading pairs', impact: 'New margin markets', source: 'Kraken Blog', verdict: 'neutral', details: 'Kraken enabled margin trading for Worldcoin (WLD/USD) and World Liberty Financial (WLFI/USD) at 3x leverage, long only. Total margin trading markets exceed 230 on Kraken Pro.' },
  { date: '2025-09-19', category: 'Expansion', event: 'Trust Wallet joins xStocks Alliance (200M users)', impact: 'Tokenized equities on self-custody wallet', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken and Backed partnered with Trust Wallet to integrate xStocks tokenized equities. Trust Wallet users will be able to buy xStocks using fiat and deposit/withdraw from exchanges including Kraken across Solana, BNB Chain, TRON, Ethereum.' },
  { date: '2025-09-18', category: 'Product', event: 'Kraken Launch platform announced (ICO/token sales)', impact: 'New Kraken product vertical', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken Launch, built in partnership with Legion, enables participation in ICOs and early token sales directly from Kraken accounts. Focuses on transparency, compliance (MiCA), and merit-based allocation.' },
  { date: '2025-09-18', category: 'Product', event: 'xStocks tokenized equities live on Kraken Pro', impact: 'Tokenized U.S. equities for non-U.S. clients', source: 'Kraken Blog', verdict: 'positive', details: 'Tokenized U.S. equities powered by Backed xStocks now available on Kraken Pro. 60 assets at launch including Apple, Tesla, S&P 500 ETF. 24/5 trading, self-custody withdrawal, 0.1% taker / -0.02% maker fees, fractional shares from $1.' },
  ...
  { date: '2025-09-02', category: 'Expansion', event: 'xStocks tokenized equities launched on Ethereum via Kraken and Backed', impact: 'USDC ecosystem on Ethereum', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken and Backed brought xStocks to Ethereum blockchain. Backed issues xStocks as ERC-20 tokens with full 1:1 collateralization. xStocks surpassed $3.5B in combined CEX and DEX volume since late June launch.' },
  { date: '2025-08-28', category: 'Expansion', event: 'U.S. Department of Commerce publishes GDP data on 9 public blockchains via Kraken', impact: 'Government blockchain adoption', source: 'Kraken Blog', verdict: 'positive', details: 'U.S. Department of Commerce selected Kraken to facilitate distribution of GDP data on nine major public blockchains. Kraken onboarded the Department as a client and helped procure cryptocurrencies for transaction fees. First G7 economy using public blockchains for official economic statistics.' },
  { date: '2025-08-20', category: 'Partnership', event: 'Kraken acquires Capitalise.ai for no-code trading automation', impact: 'Partner platform enhancement', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken acquired assets and technology of Capitalise.ai, an Israel-based pioneer of no-code natural-language trading automation. Phased rollout within Kraken Pro expected later in 2025. Enables strategy research, backtesting, and automated execution across asset classes.' },
  { date: '2025-08-20', category: 'Expansion', event: 'xStocks expand to TRON blockchain via Kraken and Backed', impact: 'Multi-chain tokenized equities', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken and Backed collaborated with TRON DAO to integrate xStocks on TRON as TRC-20 tokens. Three blockchain expansions in under 60 days. xStocks surpassed $2.5B in combined CEX and DEX volume.' },
  { date: '2025-08-12', category: 'Expansion', event: 'Kraken MiCA license fully activated across all 30 EEA countries', impact: 'EURC distribution enabled across EU', source: 'Kraken Blog', verdict: 'positive', details: 'Kraken now live in all 30 EEA countries under MiCA license authorized by Central Bank of Ireland. All EEA clients served by MiCA-regulated entity. Access to 450+ digital assets. Enables full EURC distribution through Kraken Circle partnership.' },
  { date: '2025-08-06', category: 'Partnership', event: 'Kraken adds PayPal funding for U.S. clients', impact: 'Fiat on-ramp expansion', source: 'Kraken Blog', verdict: 'positive', details: 'PayPal now available as funding option for U.S. Kraken clients. Instant USD deposits 24/7 via PayPal balance, linked bank, or card. Previously available in EU, UK, Australia. Over $1M moved during soft launch.' },
