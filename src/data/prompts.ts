...
Both prompts are the same machine with different fuel. The template is modular — to add a third ticker, duplicate and swap: company name, exchange, sector focus, competitor list, ecosystem tab scope, core-file topics, and risk/catalyst vocabulary. Everything else (format, rules, color-dot logic, mandatory checks, output structure) carries over unchanged.`,
  ...
  {
    name: "Earnings Call / Transcript Analyzer",
    description: "Paste a full or partial earnings call transcript (prepared remarks + Q&A). The prompt extracts forward-looking guidance changes, management tone shifts, analyst probing areas, and numbers that need updating in the database. Outputs a structured update brief with specific data commits.",
    variants: [
      {
        label: "ASTS",
        content: `You are a senior equity research analyst at a long/short technology hedge fund covering AST SpaceMobile (NASDAQ: ASTS). You specialize in satellite-enabled direct-to-device (D2D) cellular broadband and LEO constellations.
...
Paste the transcript below:`,
      ...
      {
        label: "BMNR",
        content: `You are a senior equity research analyst at a long/short technology hedge fund covering Bitmine Immersion Technologies (NYSE American: BMNR). You specialize in digital asset treasuries, blockchain infrastructure, and ETH/BTC ecosystem plays.
...
Paste the transcript below:`,
  ...
  },
  {
    ...
    variants: [
      {
        label: "ASTS",
        content: `You are the lead portfolio manager at a concentrated long/short technology hedge fund. You are conducting a formal quarterly thesis review on AST SpaceMobile (NASDAQ: ASTS) — a pre-revenue satellite company building a space-based cellular broadband network.
...
Paste the current Investment tab data and recent developments below:`,
      ...
      {
        label: "BMNR",
        content: `You are the lead portfolio manager at a concentrated long/short technology hedge fund. You are conducting a formal quarterly thesis review on Bitmine Immersion Technologies (NYSE American: BMNR) — a company that has pivoted from Bitcoin mining to an Ethereum treasury/staking strategy.
...
Paste the current Investment tab data and recent developments below:`,
  ...
  },
  {
    ...
    variants: [
      {
        label: "ASTS",
        content: `You are a senior equity research analyst at a long/short technology hedge fund performing forensic filing analysis on AST SpaceMobile (NASDAQ: ASTS). You are comparing two consecutive SEC filings to detect material changes that consensus may be missing.
...
Paste Filing A and Filing B below:`,
      ...
      {
        label: "BMNR",
        content: `You are a senior equity research analyst at a long/short technology hedge fund performing forensic filing analysis on Bitmine Immersion Technologies (NYSE American: BMNR). You are comparing two consecutive SEC filings to detect material changes that consensus may be missing.
...
Paste Filing A and Filing B below:`,
  ...
  },
  {
    ...
    variants: [
      {
        label: "ASTS",
        content: `You are the lead analyst on AST SpaceMobile (NASDAQ: ASTS) at a long/short technology hedge fund. You are producing a periodic research digest (weekly or monthly) for the investment committee and portfolio managers.
...
- Flag anything that requires immediate attention with ⚠️ prefix.
...
Paste the period's entries and updates below:`,
      ...
      {
        label: "BMNR",
        content: `You are the lead analyst on Bitmine Immersion Technologies (NYSE American: BMNR) at a long/short technology hedge fund. You are producing a periodic research digest (weekly or monthly) for the investment committee and portfolio managers.
...
Paste the period's entries and updates below:`,
  ...
  },
  {
    ...
    variants: [
      {
        label: "ASTS",
        content: `You are a capital structure specialist at a long/short technology hedge fund analyzing AST SpaceMobile (NASDAQ: ASTS). The company has a complex 3-class share structure with multiple convertible tranches, ATM programs, registered directs, and super-voting founder shares.
...
Paste the Capital tab data (and optionally debt footnotes) below:`,
      ...
      {
        label: "BMNR",
        content: `You are a capital structure specialist at a long/short technology hedge fund analyzing Bitmine Immersion Technologies (NYSE American: BMNR). The company uses aggressive ATM equity issuance to fund ETH treasury accumulation, making dilution analysis central to the thesis.
...
Paste the Capital tab data (and optionally balance sheet) below:`,
  ...
  },
  {
    ...
    variants: [
      {
        label: "ASTS",
        content: `You are a senior equity research analyst at a long/short technology hedge fund specializing in insider activity analysis for AST SpaceMobile (NASDAQ: ASTS). You track Form 4 filings, beneficial ownership reports, and compensation disclosures to assess insider conviction.
