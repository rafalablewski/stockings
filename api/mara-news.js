// api/mara-news.js
// Proxy for MARA (Marathon Digital Holdings) press releases via QuoteMedia/AccessWire
  ...
  try {
    ...
    const filtered = items.filter((item) => {
      ...
      return (
        ...
        (/marathon\s*digital/i.test(hl) || /\bmara\b/.test(hl) || /marathon\s*holdings/i.test(hl))
      );
    });
    ...
    console.error('mara-news error:', err);
